...
To run this script :
    $ satlomas_lstm_train config_train_lstm_temp.json -vv
...
def train_lstm(script_config):
    ...
    lstm_nnet = build_lstm_nnet(
        trainset["X"], base_config, mid_layers_config, model_loss, optimizer
    )
