...
"""
def read_time_series_from_csv(dataset_filename = '../data/meteorologico/sudeste.csv',
								date_col = 'date',
								hr_col = 'hr',
								numeric_var = 'temp',
								sensor_var = 'inme'
	...
	dataset = pd.read_csv(dataset_filename, header=0, index_col=0,nrows=None,usecols=cols_to_read)
