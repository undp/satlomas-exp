...
"""
	...
	TODO: improve this doc, add parameter documentation
"""
...
"""
	...
	TODO: improve this doc, add parameter documentation
"""
def get_interest_variable(in_dataset,
						sensor_var,
						date_col,
						hr_col,
						numeric_var,
	...
	dataset_pproc = in_dataset.loc[in_dataset[sensor_var]==target_sensor,[date_col,hr_col] + [numeric_var]]
